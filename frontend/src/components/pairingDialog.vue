<template>
  <q-dialog v-model="isPairingDialogOpen">
    <q-card style="width: 65%; height: 90%; border-radius: 20px">
      ...
      <q-card-section align="center">
        ...
        <div class="q-pt-none" style="position: absolute; top: 80%; left: 32%">
          <ActionButton
            size="md"
            text-label="Open Bluetooth"
            color="green"
            text-color="white"
            @click="() => openBluetoothSetting(bluetoothSerial)"
            v-close-popup
          />
        </div>
      </q-card-section>
